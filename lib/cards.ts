...
export const CARDS: Card[] = [
  ...
  },
  {
    ...
    textColor: "#ffffff",
    accentColor: "#f5c842",
    description: "3% cash back on everything. Requires Robinhood Gold membership ($5/mo).",
    perks: [
      { id: "rh-gold-cashback-all", name: "3% Cash Back on Everything", description: "Unlimited 3% cash back on all purchases — no rotating categories, no caps, no games.", value: 750, category: "other", frequency: "annual", notes: "Est. value based on $25k annual spend" },
      { id: "rh-gold-cashback-travel", name: "5% Cash Back on Travel", description: "5% back on travel booked through Robinhood Travel portal — flights, hotels, car rentals.", value: 100, category: "travel", frequency: "annual", notes: "Est. value based on $2k annual travel spend" },
      { id: "rh-gold-phone", name: "Cell Phone Protection", description: "Up to $800 per claim, up to $1,000 per year, for theft or damage when you pay your phone bill with the card.", value: 800, category: "insurance", frequency: "annual", notes: "$50 deductible per claim" },
      { id: "rh-gold-extended", name: "Extended Warranty", description: "Doubles the manufacturer's warranty on eligible purchases up to one additional year.", value: 0, category: "insurance", frequency: "annual" },
      { id: "rh-gold-purchase", name: "Purchase Protection", description: "Covers eligible purchases against damage or theft for 90 days from purchase date.", value: 0, category: "insurance", frequency: "annual" },
    ],
  },
  {
    ...
    perks: [
      { id: "gem-dining", name: "3% Back on Dining (in Crypto)", description: "3% back in Bitcoin or crypto of your choice on all restaurant and dining purchases. Rewards credited instantly.", value: 360, category: "dining", frequency: "annual", notes: "Est. based on $12k dining spend/yr. Value fluctuates with crypto prices." },
      { id: "gem-grocery", name: "2% Back on Groceries (in Crypto)", description: "2% back in crypto on all grocery store purchases.", value: 200, category: "shopping", frequency: "annual", notes: "Est. based on $10k grocery spend/yr" },
      { id: "gem-everything", name: "1% Back on Everything (in Crypto)", description: "1% back in crypto on all other purchases. Credited to your Gemini account in real time.", value: 160, category: "other", frequency: "annual", notes: "Est. based on $16k other spend/yr" },
      { id: "gem-no-foreign", name: "No Foreign Transaction Fees", description: "Use your Gemini card abroad with no additional fees on international transactions.", value: 0, category: "travel", frequency: "annual" },
      { id: "gem-phone", name: "Cell Phone Protection", description: "Up to $1,000 per claim for theft or damage when you pay your phone bill with the card.", value: 0, category: "insurance", frequency: "annual", notes: "Mastercard World Elite benefit" },
    ],
  },
];
